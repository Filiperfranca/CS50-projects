...
person *create_family(int generations)
{
    ...
    if (generations > 1)
    {
        ...
        nova_pessoa->parents[0] = parent0;
        nova_pessoa->parents[1] = parent1;

        // TODO: Randomly assign current person's alleles based on the alleles of their parents
        nova_pessoa->alleles[0] = parent0->alleles[random() % 2];
        nova_pessoa->alleles[1] = parent1->alleles[random() % 2];
    }
